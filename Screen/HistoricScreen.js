  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.mapContainer}>
        ...
        {/* Node Positions */}
          <View style={[styles.node, { top: '7%', left: '70%', backgroundColor: data[0].Status ? 'red' : '#1A237E' }]}>
            <Text style={styles.nodeText}>1</Text>
          </View>
          <View style={[styles.node, { top: '47%', left: '50%', backgroundColor: data[1].Status ? 'red' : '#1A237E' }]}>
            <Text style={styles.nodeText}>2</Text>
          </View>
          <View style={[styles.node, { top: '82%', left: '20%', backgroundColor: data[2].Status ? 'red' : '#1A237E' }]}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity style={[styles.nodeButton, { backgroundColor: data[0].Status ? 'red' : '#1A237E' }]}onPress={() => navigation.navigate('NodeInfo1')}>
          <Text style={styles.buttonText}>Node 1</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.nodeButton, { backgroundColor: data[1].Status ? 'red' : '#1A237E' }]}onPress={() => navigation.navigate('NodeInfo2')}>
          <Text style={styles.buttonText}>Node 2</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.nodeButton, { backgroundColor: data[2].Status ? 'red' : '#1A237E' }]}onPress={() => navigation.navigate('NodeInfo3')}>
